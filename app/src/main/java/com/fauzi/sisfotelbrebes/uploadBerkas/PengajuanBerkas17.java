...
public class PengajuanBerkas17 extends AppCompatActivity implements View.OnClickListener {
    ImageView imageView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pengajuan_berkas17);
...
//    String kode = "2";
        ...
        call.enqueue(new Callback<UploadBerkas>() {
            ...
            public void onResponse(Call<UploadBerkas> call, Response<UploadBerkas> response) {
                ...
                if (value.equals("1")){
                    Intent intent = new Intent(PengajuanBerkas17.this, PengajuanBerkas18.class);
                    startActivity(intent);
                    finish();
                } else {
                    Toast.makeText(PengajuanBerkas17.this, message, Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onFailure(Call<UploadBerkas> call, Throwable t) {
                progressDialog.dismiss();
                Toast.makeText(PengajuanBerkas17.this, t.getMessage().toString(), Toast.LENGTH_SHORT).show();
