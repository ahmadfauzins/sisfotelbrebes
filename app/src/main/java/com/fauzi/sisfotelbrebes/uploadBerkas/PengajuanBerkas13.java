...
public class PengajuanBerkas13 extends AppCompatActivity implements View.OnClickListener {
    ImageView imageView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pengajuan_berkas13);
    ...
    public void onClick(final View v) {
        switch (v.getId()) {
            case R.id.pickImage:
                ...
                break;
            case R.id.upload:
                uploadFile("srt_perny_aksesjalan");
                break;
        }
    }
...
//    String kode = "2";
        ...
        call.enqueue(new Callback<UploadBerkas>() {
            ...
            public void onResponse(Call<UploadBerkas> call, Response<UploadBerkas> response) {
                ...
                if (value.equals("1")){
                    Intent intent = new Intent(PengajuanBerkas13.this, PengajuanBerkas14.class);
                    startActivity(intent);
                    finish();
                } else {
                    Toast.makeText(PengajuanBerkas13.this, message, Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onFailure(Call<UploadBerkas> call, Throwable t) {
                progressDialog.dismiss();
                Toast.makeText(PengajuanBerkas13.this, t.getMessage().toString(), Toast.LENGTH_SHORT).show();
