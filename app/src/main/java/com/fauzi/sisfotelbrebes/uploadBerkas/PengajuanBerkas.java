...
public class PengajuanBerkas extends AppCompatActivity implements View.OnClickListener {
    ImageView imageView;
    ...
    private static final String TAG = PengajuanBerkas.class.getSimpleName();
...
//        }
    ...
    private void uploadFile() {
        ...
        Call<UploadBerkas> call = apiInterface.UploadData(key, id_Pengajuan, "2222",picture);
        ...
        call.enqueue(new Callback<UploadBerkas>() {
            ...
            public void onFailure(Call<UploadBerkas> call, Throwable t) {
                progressDialog.dismiss();
                Toast.makeText(PengajuanBerkas.this, t.getMessage().toString(), Toast.LENGTH_SHORT).show();
